...
<c:forEach var="i" begin="1" end="8">
    <div class="col-md-4 mt-2">
        <label for="size${i + 35}" class="form-label">Size ${i + 35}</label>
        <input name="${i}" type="number" class="form-control" id="size${i + 35}" min="0" 
               value="${variationQuantities[i] != null ? variationQuantities[i] : 0}"/>
    </div>
</c:forEach>
