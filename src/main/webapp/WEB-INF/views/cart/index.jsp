								...
								<tbody>
									<tr>
										...
										<td class="align-middle">
											<div class="d-flex align-items-center">
												<div class="text">
													...
													<br>
														<small class="text-muted text-wrap" style="color: red !important;">Size: ${c.size }</small>
												</div>
											</div>
										</td>
										...
										<td class="align-middle"><a role="button"
											...
											<a role="button"
											href="cart/quantity/plus.htm?productID=${c.product.productId}&quantity=${c.quantity}&size=${c.size}"
										...
										<td class="align-middle "><a
											href='<c:url value = "cart/delete/${c.product.productId}.htm?size=${c.size}"/>'
