...
import tad.TemplatePattern.ResetPasswordEmailHandler;
...
//	}
	...
	//Áp dụng Template Pattern
	@Autowired
	ResetPasswordEmailHandler resetPasswordEmailHandler;

	@RequestMapping(value = "resend-password", method = RequestMethod.POST)
	public String resendPassword(@RequestParam("email") String email,
	                             HttpServletRequest request,
	                             RedirectAttributes reAttributes) {
	    return resetPasswordEmailHandler.execute(email, request, reAttributes);
	}
